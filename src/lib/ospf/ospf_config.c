/* 
 * $Id: ospf_config.c,v 1.1.1.1 2000/08/14 18:46:12 labovit Exp $
 */

// Initialize and configure OSPF protocol
...
void config_dump_ospf_table (uii_connection_t *uii, char *format, char *interval) {
  ...
  trace (NORM, OSPF.trace, "Config OSPF dump table %s %s [%d seconds]\n", 
...
void config_dump_ospf_updates (uii_connection_t *uii, char *format, char *interval) {
  ...
  trace (NORM, OSPF.trace, "Config OSPF dump updates %s %s [%d seconds]\n", 
...
void config_network_ospf_password (uii_connection_t *uii, 
  ...
  trace (NORM, OSPF.trace, "Config OSPF network %s authentication %s\n", 
...
void config_ip_ospf_routerid (uii_connection_t * uii, prefix_t *prefix) {
  ...
  trace (NORM, OSPF.trace, "Config OSPF router-id %s\n", 
	 prefix_toa (prefix));
  Delete (prefix);
...
void config_ip_ospf_hello_interval (uii_connection_t * uii, int interval) {
  ...
  trace (NORM, OSPF.trace, "Config OSPF default_hello_interval %d\n", 
...
void config_ip_ospf_dead_interval (uii_connection_t * uii, int interval) {
  ...
  trace (NORM, OSPF.trace, "Config OSPF default_dead_interval %d\n", 
...
void config_ospf_area_virtual_link (uii_connection_t * uii, int area, prefix_t *prefix) {
  ...
  trace (NORM, OSPF.trace, "Config ospf virtrual link %s area %d\n", 
