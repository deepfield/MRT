/*
 * $Id: interface.h,v 1.1.1.1 2000/08/14 18:46:15 labovit Exp $
 */
...
typedef struct _Interface_Master_Struct {
   LINKED_LIST *ll_interfaces; 		/* ll of Interface_Struct */
} Interface_Master_Struct;
